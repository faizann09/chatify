  ...
  return (
    <div className="h-screen w-full bg-slate-950 text-white flex flex-col items-center justify-center">
      <div className="text-center">
        ...
        <p className="mt-4 text-3xl text-white-400">
            Welcome, <span className="font-semibold mt-5">{authUser.user.name}</span>
          </p>
        {/* <h1 className="text-3xl font-semibold mb-3">Chat not Selected</h1> */}
